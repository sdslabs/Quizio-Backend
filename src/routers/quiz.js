...
router.get('/sections/:sectionID/:accessCode', isAuth, sectionController.getSectionByIDWithAccessCode);
...
router.get('/sections/questions/:questionID/:accessCode', isAuth, questionController.getQuestionByIDWithAccessCode);
