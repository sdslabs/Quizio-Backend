...
const {
	MONGO_USERNAME, MONGO_PASSWORD, MONGO_HOSTNAME, MONGO_INITDB_DATABASE,
} = process.env;
...
const MONGOURI = `mongodb://${MONGO_USERNAME}:${MONGO_PASSWORD}@${MONGO_HOSTNAME}:27017/${MONGO_INITDB_DATABASE}`;
